...
public class LabRequestController {
    ...
    public TestRequest assignForLabTest(@PathVariable Long id) {
        ...
        try {
            User user = userLoggedInService.getLoggedInUser();
            TestRequest testResult = testRequestUpdateService.assignForLabTest(id, user);
            return testResult; // replace this line of code with your implementation
...
User tester = userLoggedInService.getLoggedInUser();
            TestRequest testResult = testRequestUpdateService.updateLabTest(id,createLabResult,tester);
            return testResult; // replace this line of code with your implementation
